...
def customize_line_plot():
    fig, ax = plt.subplots()
    ax.plot(months, product_A_sales, label="Product A", color="chocolate", linestyle='--', marker='o')
    ax.plot(months, product_B_sales, label="Product B", color="magenta", linestyle='-', marker='x')
...
def tren_line_plot():
    ...
    axs.plot(months, product_C_sales, label="Product C", color="maroon", linestyle='-.', marker='o')
    axs.plot(months, product_D_sales, label="Product D", color="orange", linestyle=':', marker='x')
