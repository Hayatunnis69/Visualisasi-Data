...
fig, ax = plt.subplots()
ax.bar(data['Jurusan'], data['Jumlah Mahasiswa'], color='brown')
ax.set_title('Jumlah Mahasiwa Per Jurusan')
...
fig, ax = plt.subplots()
colors = ['maroon', 'orange', 'blue', 'chocolate']
...
ax.bar([p + width for p in x ], data_2024, width=width, label='2024', color='pink')
